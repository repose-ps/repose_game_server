...
public enum Direction {
	...
	/**
	 * An array of directions without any diagonal directions, and one step
	 * counter-clockwise, as used by the clients collision mapping.
	 */
	public final static Direction[] WNES = { WEST, NORTH, EAST, SOUTH };

	/**
	 * An array of diagonal directions, and one step counter-clockwise, as used by
	 ...
	 */
	public static Direction between(TilePosition current, TilePosition next) {
	...
	/**
	 * Get the 2 directions which make up a diagonal direction (i.e., NORTH and EAST
	 * for NORTH_EAST).
	 *
	 ...
	 *
	 * @return {@code true} if this direction is a diagonal direction, {@code false}
	 *         otherwise.
	 */
	...
	/**
	 * Gets the direction as an integer as used orientation in the client maps (WNES
	 * as opposed to NESW).
	 *
